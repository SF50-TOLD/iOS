...
struct LogViewer: View {
  ...
  var minimumLevel: Logger.Level = .notice

  private var filteredEntries: [LogEntry] {
    logEntries.filter { $0.level >= minimumLevel }
  }
...
#Preview {
  LogViewer(logEntries: [
    ...
    LogEntry(
      ...
      level: .info,
      message: "This info message is filtered out by default",
      metadata: nil
    ),
    LogEntry(
