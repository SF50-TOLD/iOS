...
/// Shared geographic calculation utilities for airport data processing.
enum GeoCalculations {
  ...
  static func calculateBearing(from: (Float, Float), to: (Float, Float)) -> Float {
  ...
  static func calculateMagneticVariation(_ latitudeDeg: Double, _ longitudeDeg: Double) -> Double {
  ...
  static func calculateDistanceNM(
    fromLat: Double,
    fromLon: Double,
    toLat: Double,
    toLon: Double
