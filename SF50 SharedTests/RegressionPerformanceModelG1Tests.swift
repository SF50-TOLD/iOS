...
struct RegressionPerformanceModelG1Tests {
  ...
  // MARK: - Enroute Obstacle Climb Tests - Normal

  @Test
  func enrouteObstacleClimbGradient_normal_withinTolerance() throws {
    let csvURL = Bundle(for: BasePerformanceModel.self).resourceURL!
      .appending(component: "Data/g1/enroute obstacle climb/normal/gradient.csv")
    let dataTable = try DataTable(fileURL: csvURL)
  ...
  @Test
  func enrouteObstacleClimbRate_normal_withinTolerance() throws {
    let csvURL = Bundle(for: BasePerformanceModel.self).resourceURL!
      .appending(component: "Data/g1/enroute obstacle climb/normal/rate.csv")
    let dataTable = try DataTable(fileURL: csvURL)
    ...
    validateRegressionPredictions(
      ...
      valueExtractor: { $0.enrouteObstacleClimbRateFtMin },
      testName: "enrouteObstacleClimbRate_normal"
    )
  }

  // MARK: - Enroute Obstacle Climb Tests - Ice Contaminated

  @Test
  func enrouteObstacleClimbGradient_iceContaminated_withinTolerance() throws {
    let csvURL = Bundle(for: BasePerformanceModel.self).resourceURL!
      .appending(component: "Data/g1/enroute obstacle climb/ice/gradient.csv")
    let dataTable = try DataTable(fileURL: csvURL)
  ...
  @Test
  func enrouteObstacleClimbRate_iceContaminated_withinTolerance() throws {
    let csvURL = Bundle(for: BasePerformanceModel.self).resourceURL!
      .appending(component: "Data/g1/enroute obstacle climb/ice/rate.csv")
    let dataTable = try DataTable(fileURL: csvURL)
    ...
    validateRegressionPredictions(
      ...
      valueExtractor: { $0.enrouteObstacleClimbRateFtMin },
      testName: "enrouteObstacleClimbRate_iceContaminated"
    )
  }
