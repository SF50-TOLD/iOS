...
extension RunwaySnapshot {
  /// Orders snapshots by designator, as ``RunwayDesignator/compare(_:_:)`` defines it.
  ///
  /// This is the same order `Runway.NameComparator` puts the SwiftData models in, which is what keeps
  /// the widget's four runways the app's four runways.
